# 1 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c"
...
# 1 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
...
# 2 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
...
# 3 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
...
# 4 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2

# 1 "UC04_home_page.c" 1
UC04_home_page()
{
	...
	lr_start_transaction("UC04_TR01_home_page");
	
	web_url("UC04_TR01_home_page", 
		"URL=http://{host}:{port}/", 
		"TargetFrame=", 
		"Resource=0", 
	...
	lr_end_transaction("UC04_TR01_home_page", 2);
	
	return 0;
}
# 5 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
...
UC04_login()
{
	...
	lr_end_transaction("UC04_TR02_login", 2);
	
	return 0;
}
# 6 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2

# 1 "UC04_chenge_10_item.c" 1
UC04_chenge_10_item()
{
...
# 7 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2

# 1 "UC04_select_random.c" 1
UC04_select_random()
{
...
# 8 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
...
UC04_logout()
{
	...
	lr_end_transaction("UC04_TR03_logout", 2);
	
	return 0;
}
# 9 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
...
# 10 "d:\\loadrunner\\uc04_pagination\\\\combined_UC04_pagination.c" 2
